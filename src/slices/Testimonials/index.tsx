...
const components: JSXMapSerializer = {
  ...
  heading2: ({children})=>(
    ...
    as="h2"
    size="md"
    className="text-center mb-9 font-semi">
      {children}
    </Heading>
  ),
    ...
    >
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-8">
        {testimonials.map((item, index) => item &&(
            <div key={index} className="border hover:bg-slate-200  bg-white shadow-lg rounded-lg px-8 md:px-14 py-10 md:py-16  grid content-betwen">
